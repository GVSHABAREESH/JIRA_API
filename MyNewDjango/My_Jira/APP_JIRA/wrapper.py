...
class jirawrapper(object):
    ...
    #     project = self.jira.delete_project(pid=10031)
    #     return project

    def issue_creation(self,data):
        try:
            project = self.jira.create_issue(project=data['project']['key'], summary=data['summary'],description=data['description'],issuetype=data['issuetype'])
            return project
        except:
